...
Tutors will be able to create a calendar of their availability, which is public to all website users. They will also be able to post a public list of classes they are willing to tutor, along with the rates they will charge. Tutors will be required to provide proof of grades in the classes that they wish to tutor. There will be a 5 star rating system for tutors, that is only available for use after a confirmed tutoring session but will be visible to everyone
...
Users will also be able to register as a tutor and a student looking for a tutor. They will have access to all website features, but will not be able to teach a class that they are currently getting help with.
